...
<h2 style="text-align:center;color:grey;">Edit the Teams</h2></div>
<div class="new">
<br/>
<ul>
  <li style="font-size:24px;"ng-repeat="names in names track by $index"><a  href="teamedit.php?teamname={{names}}">{{names}}</a></li>
</ul>
</br>
</br>
<button type="button"class="button1" value="EDIT" onclick="add()"><span class="glyphicon glyphicon-save"></span>ADD A NEW TEAM</button>
</div>
</div>
</div>
</body>
