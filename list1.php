  ...
  <div class="container-fluid" style="height:50px;width:1365px;">
    <nav class="navbar navbar-inverse navbar-fixed-top">
      ...
      <div class="collapse navbar-collapse">
        ...
        <li class="active"><a href="tdetails1.php">Tournament Details</a></li>
...
<div class="new">
    <h3>TOURNAMENT NAME:<?php echo strtoupper($_SESSION['tournname']);?></h3>
    <h3>TEAM NAME:<?php echo strtoupper($_SESSION['teamname']);?></h3>
    </br>
